...
let videoCardEventsBound = false;
...
function renderVideoGrid() {
  ...
  container.innerHTML = filtered.map((item, index) => {
    ...
    const ownerUrl = `https://space.bilibili.com/${item.owner.mid}`;
      ...
      <div class="video-card" data-video-url="${videoUrl}">
        ...
        <div class="video-info">
          ...
          <div class="bili-video-card__info--owner">
             ...
             <a class="video-owner-name" href="${ownerUrl}" target="_blank" rel="noopener">${item.owner.name}</a>
...
function bindVideoCardEvents() {
  if (!videoContainer || videoCardEventsBound) return;
  videoCardEventsBound = true;
